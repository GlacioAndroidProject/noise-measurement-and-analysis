package com.example.noisemeasurement.ProccessBarUI;
...
import com.example.noisemeasurement.R;


/**
 * Created by arnold on 16/3/16.
 */
public class SoundLevelView extends View{
    ...
    public SoundLevelView(Context context, AttributeSet attrs) {
        ...
        mGreen 	= context.getResources().getDrawable(R.drawable.greenbar, getContext().getTheme());
        mRed 	= context.getResources().getDrawable(R.drawable.redbar,getContext().getTheme());
